package com.okkristen.project.logic.other.database.entity;
 ...
 */
@Entity
@Table(name = "database_filed")
@DynamicUpdate
@DynamicInsert
public class DatabaseFiled extends BaseEntity implements Serializable {
