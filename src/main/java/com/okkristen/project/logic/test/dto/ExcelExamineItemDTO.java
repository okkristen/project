...
//     * 分组名（附加分...)
//     */
//    @Excel(name="分组名", orderNum="1", isImportField = "groupName")
//    private String groupName;
//
//    /**
//     * 评分项（断面水质...)
//     */
//    @Excel(name="评分项", orderNum="2", isImportField = "gradeNape")
//    private String gradeNape;
//
//    /**
//     * 可选分数（0,5,15）
//     */
//    @Excel(name="可选分数", orderNum="3", isImportField = "grade")
//    private String grade;
//
//    /**
//     * 说明
//     */
//    @Excel(name="说明", orderNum="4", isImportField = "illustrate")
